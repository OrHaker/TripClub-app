...
namespace TripClubWebService.Controllers
{
    ...
    public class SystemToolsController : ApiController
    {
        ...
        //http://localhost:59821/KeyComparison?email=or.haker95@gmail.com&key=155151
        [Route("KeyComparison")]
        [HttpGet]
        ...
        //http://localhost:59821/PasswordResetRequest?email=or.haker95@gmail.com
        ...
        public IHttpActionResult PasswordResetRequest(string email)
        {
            try
            {
                ...
                const string resetPassUrl = @"http://185.60.170.14/plesk-site-preview/ruppinmobile.ac.il/site02/build/";
                const string img = @"https://image.freepik.com/free-vector/open-locker_53876-25497.jpg";

                MailMessage mail = new MailMessage();
                SmtpClient SmtpServer = new SmtpClient("smtp.gmail.com");

                mail.From = new MailAddress("tripclubapp@gmail.com");
                mail.To.Add(email);
...
אחרת, אנא לחץ כדי לאפס את הסיסמה שלך על ידי לחיצה                   
      ...
      <div style ='background-color:#b7b7a4;bottom:0;position:absolute;width:100%;color:#000;text-align:center;'>
           <h3>?יש שאלות או תהיות</h3>
              <p>אנחנו כאן כדי לעזור, צרו קשר כאן  <a href = 'mailto:tripclubapp@gmail.com'> TripClubApp ltd </a></p>
                  </div>";
                mail.Body = htmlBody;

                SmtpServer.Port = 587;
                SmtpServer.Credentials = new System.Net.NetworkCredential("tripclubapp@gmail.com", "App123456");
        ...
        public IHttpActionResult Post([FromBody] NewEmailAndPassword obj)
        {
            try
            {
                ...
                int rowsAffected = UserDB.UserForgotPassword(obj.Email, obj.Password);
